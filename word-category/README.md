...
```javascript
// Get all categories
const categories = await fetch('https://cdn.jsdelivr.net/gh/Naandalist/kbbi-harvester-cdn@main/word-category/kategori.json')
  .then(r => r.json());

// Get only word classes
const wordClasses = await fetch('https://cdn.jsdelivr.net/gh/Naandalist/kbbi-harvester-cdn@main/word-category/kelas-kata.json')
  .then(r => r.json());

// Get language classifications  
const languages = await fetch('https://cdn.jsdelivr.net/gh/Naandalist/kbbi-harvester-cdn@main/word-category/bahasa.json')
  .then(r => r.json());

// Get subject domains
const subjects = await fetch('https://cdn.jsdelivr.net/gh/Naandalist/kbbi-harvester-cdn@main/word-category/bidang-subjek.json')
  .then(r => r.json());

// Get miscellaneous categories
const misc = await fetch('https://cdn.jsdelivr.net/gh/Naandalist/kbbi-harvester-cdn@main/word-category/lainnya.json')
  .then(r => r.json());
```
...
Part of [KBBI CDN Dataset](https://github.com/Naandalist/kbbi-harvester-cdn). Data extracted August 6, 2025.
